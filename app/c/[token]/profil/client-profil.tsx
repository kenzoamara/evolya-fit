...
export function ClientProfil({ client, coachName, coachingType }: Props) {
  ...
  return (
    <main className="flex-1 px-4 sm:px-6 lg:px-10 py-6 sm:py-8 space-y-4">
      ...
      >
        <div className="w-12 h-12 rounded-2xl flex items-center justify-center text-[18px] font-bold text-white flex-shrink-0" style={{ background: 'rgba(255,255,255,0.15)' }}>
