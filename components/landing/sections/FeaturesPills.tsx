...
const TOOLS = [
  ...
  },
  {
    ...
    desc: "Couleurs, police, logo — personnalise Evolya'Fit pour que tes membres vivent une expérience à ta marque. La différence entre un freelance et un cabinet professionnel.",
    bullets: [
      'Couleurs et police à ton image',
      'Icône et identité visuelle personnalisées',
      'Interface membre à ta marque',
